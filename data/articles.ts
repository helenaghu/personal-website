...
Everything I learned about being a woman I've learned from a mother. Most of the things I've learned have come from my own mother. Cheers to that!`,
  },
  {
    ...
    date: "2026-04-26",
    content: `Lately I've been asked quite a few times to share a fun fact about myself. The other day I was at a nice dinner with a group of friends, where everyone went around the table with a fun fact, and I recently joined a new team at work where I was asked to submit a fun fact about myself as an introduction to the organization.
...
19. All you have is yourself. In the last year, I've challenged myself to be more selfish. I've learned that at this age, it's in my best interest to put myself first. I'm lucky enough to be in a position to do so.

20. Place no budget on once in a lifetime experiences. Opportunities present themselves at random times, and they may not ever again, so don't be afraid to spend money on experiences you've always wanted to have.

21. Smile lots :). It takes 10 muscles to smile and 50 muscles to frown. I've been called out by colleagues, managers, even senior leaders at work for having a big, cheesy, smile on my face (maybe at the wrong time) but I'd like to think that they remember me for being cheery and showing up with a positive attitude. It's hard to be put down when you have a big smile on your face, even if you have to fake it until you make it.

22. You're only 23 once! I have the voice of my dear friend echoing in the back of my mind as I write this, reminded of all the times she's convinced me on a night out with this one line. Writing this on my last day of 23 and thinking about how we'll have to upgrade this phrase to "you're only 24 once!", I've come to realize that…

23. You'll never be this young ever again. A lot of 20-somethings dread the tick of each year, myself included. What has helped me get over the fear is realizing where I am now is not anywhere close to where I might be in a year or two. Make good choices, be smart, but have fun (and don't be afraid to take a risk!)
